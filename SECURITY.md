...
The `LRAC Data Generation` maintainers take all security issues in the project
seriously. Thank you for improving the security of `LRAC Data Generation`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`LRAC Data Generation` leverages GitHub's private vulnerability reporting.
